...
/*   Updated: 2023/11/06 15:09:38 by mkhairal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    PhoneBook::search()
{
    ...
    std::cin >> index;
    if (index < 0 || index > this->_currentIndex || !Contact::validContact(contacts[index]))
    {
        std::cerr << "no contact for this index" << std::endl;
        return ;
    }
    else
